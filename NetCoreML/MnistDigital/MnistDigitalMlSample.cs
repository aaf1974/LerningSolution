...
using NetCoreML.MnistDigital.DataStruct;

namespace NetCoreML.MnistDigital
{
    //https://github.com/dotnet/machinelearning-samples/tree/master/samples/csharp/getting-started/MulticlassClassification_MNIST
    internal class MnistDigitalMlSample
    {

        private static string BaseDatasetsRelativePath = @"../../../MnistDigital/Data";
        ...
        private static string BaseModelsRelativePath = @"../../../MnistDigital/MLModels";
