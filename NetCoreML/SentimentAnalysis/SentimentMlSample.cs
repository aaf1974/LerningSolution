...
namespace NetCoreML.SentimentAnalysis
{
    class SentimentMlSample
    {
        static readonly string _dataPath = Path.Combine(Environment.CurrentDirectory, "SentimentAnalysis", "Data", "yelp_labelled.txt");
